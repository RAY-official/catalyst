...
const uint64_t CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE           = 15;
...
const uint64_t DEPOSIT_MAX_TOTAL_RATE                        = 2; // percentage rate for DEPOSIT_MAX_TERM
...
const uint64_t ICO_BLOCK_REWARD	                             = (UINT64_C(1) * parameters::COIN); // 20.4 billion ICO
const uint64_t MAX_BLOCK_REWARD                              = (UINT64_C(3000) * parameters::COIN);
...
const int      P2P_DEFAULT_PORT                              = 4050;
const int      RPC_DEFAULT_PORT                              = 4051;
...
const std::initializer_list<const char*> SEED_NODES = {
  "seed1.catalyst.cash :4050",
  "seed2.catalyst.cash:4050",
};
...
const std::initializer_list<CheckpointData> CHECKPOINTS = {
  { 4, "346527025df3ce29434920e9447063c6fb732006abd97baaa45f54c73f7eec35" },
  { 23, "1191460a73fc727d79ae60e2bdd283fba92547b031addddf13e2cf1acb807385" },
  { 24, "7fc56fd4c6add9e35301093ac5846ab368bbfdd1c4b6e1860d18d9561ce35670" }, 
};
